...
import com.github.vini2003.spinnery.util.JanksonUtilities;
...
public class Style {
	...
	public Size asSize(String property) {
		...
		return Size.of(array.get(int.class, 0), array.get(int.class, 1));
	}
	...
	public Padding asPadding(String property) {
		...
		if (array.size() == 1) {
			return Padding.of(array.get(int.class, 0));
		} else if (array.size() == 2) {
			return Padding.of(array.get(int.class, 0), array.get(int.class, 1));
		} else if (array.size() >= 4) {
			return Padding.of(array.get(int.class, 0), array.get(int.class, 1), array.get(int.class, 2), array.get(int.class, 3));
		}
		return Padding.of(0);
	}
	...
	public Position asPosition(String property) {
		...
		JsonArray array = (JsonArray) el;
		return Position.of(array.get(int.class, 0), array.get(int.class, 1), array.get(int.class, 2));
	}
	...
	public Position asAnchoredPosition(String property, WAbstractWidget anchor) {
		...
		JsonArray array = (JsonArray) el;
		return Position.of(anchor, array.get(int.class, 0), array.get(int.class, 1), array.get(int.class, 2));
	}

	/**
	 * Returns a given property as an ResourceLocation.
	 *
	 * @param property Property to be retrieved.
	 * @return Property as an ResourceLocation, defaulting to an empty one if conversion fails.
	 */
