...
public class Theme {
	...
	public static Theme of(ResourceLocation themeId, JsonObject themeDef) {
		...
		ResourceLocation parent = JanksonUtilities.asString(parentProp).map(ResourceLocation::new).orElse(null);
	...
	/**
	 * Retrieves the ResourceLocation of this theme.
	 *
	 * @return The ResourceLocation of this theme.
	 */
	 ...
	 *
	 * @param widgetId ResourceLocation of the widget, which must have been registered via WidgetRegistry.
