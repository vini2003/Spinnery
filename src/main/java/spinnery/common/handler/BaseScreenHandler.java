package spinnery.common.handler;
...
public class BaseScreenHandler extends ScreenHandler {
	...
	/**
	 * Instantiates a BaseScreenHandler.
	 *
	...
	/**
	 * Retrieves map of inventories associated with this handler.
	 *
	 * @return All inventories associated with this handler, whose key is the inventory number.
	 */
	...
	/**
	 * Sets the World of this handler.
	 *
	 * @param world World to be associated with this handler.
	 */
	...
	@Environment(EnvType.CLIENT)
	public void flush() {
		getInterface().getHandler().getDragSlots(GLFW.GLFW_MOUSE_BUTTON_1).clear();
		getInterface().getHandler().getDragSlots(GLFW.GLFW_MOUSE_BUTTON_2).clear();
		getInterface().getHandler().getPreviewStacks().clear();
		getInterface().getHandler().setPreviewCursorStack(ItemStack.EMPTY);
	}
	...
	/**
	 * Retrieves the WInterface attached with this handler.
	 *
	 * @return The WInterface attached with this handler.
	 */
	...
	/**
	 * Retrieves the World associated with this handler.
	 *
	 * @return World associated with this handler.
	 */
	...
	/**
	 * Retrieves the PlayerInventory of the Player associated with this handler.
	 *
	 * @return PlayerInventory of player associated with this handler.
	 */
	...
	/**
	 * Retrieves an inventory from the BaseScreenHandler.
	 *
	...
	/**
	 * Adds an inventory to the BaseScreenHandler.
	 *
	 * @param inventoryNumber Inventory number associated with the inventory.
	 * @param inventory       Inventory associated with the inventory number.
	 */
	public <C extends BaseScreenHandler> C addInventory(int inventoryNumber, Inventory inventory) {
	...
	public Slot addSlot(Slot slot) {
		throw new UnsupportedOperationException(Slot.class.getName() + " cannot be added to a Spinnery " + BaseScreenHandler.class.getName() + "!");
	}
